  ...
  <section class="org-panel">
    ...
    <div class="org-panel__header">
      ...
      <div class="org-panel__header-right">
        ...
        <span
          class="org-panel__sub-status"
          :class="'org-panel__sub-status--' + subscription.status"
        >
          {{ subscription.status }}
        </span>
    ...
    <div v-show="!collapsed">
      ...
      <div class="org-panel__summary-strip">
        ...
        <div class="org-panel__stat-card">
          ...
          <div>
            <span class="org-panel__stat-value"
              >{{ usageSummary.projectCount
              }}<span class="org-panel__stat-max"
        ...
        <div class="org-panel__stat-card">
          ...
          <div>
            ...
            <div class="org-panel__usage-bar">
              <div
                class="org-panel__usage-fill org-panel__usage-fill--ok"
                :style="
                  usageFillStyle(
                    usageSummary.doneTasks,
                    usageSummary.totalTasks,
                  )
                "
              ></div>
            </div>
        ...
        <div class="org-panel__stat-card">
          ...
          <div>
            ...
            <span class="org-panel__stat-label">{{
              subscription.price > 0 ? "per month" : "Current Plan"
            }}</span>
            <span class="org-panel__stat-sub">{{
              subscription.price > 0
                ? "€" + (subscription.price * 12).toFixed(2) + "/yr"
                : "Upgrade available"
            }}</span>
          </div>
        </div>
        ...
        <div class="org-panel__stat-card">
          ...
          <div>
            <span class="org-panel__stat-value"
              >{{ subscription.sharedStorageGb }} GB</span
            >
            <span class="org-panel__stat-label">Shared / project</span>
            <span class="org-panel__stat-sub"
              >{{ subscription.privateStorageGb }} GB private/user</span
            >
          </div>
        </div>
      </div>
      ...
      <div class="org-panel__grid">
        ...
        <div class="org-panel__card org-panel__card--projects">
          ...
          >
              ...
              <div class="org-panel__project-info">
                ...
                <span class="org-panel__project-meta">
                  ...
                  <span
                    ...
                    class="org-panel__overdue-badge"
                    >{{ project.overdue }} overdue</span
                  >
                </span>
              </div>
              <div class="org-panel__project-right">
                <span class="org-panel__progress-label"
            ...
            <div
              v-if="expandedProjects[project.id] && project.stacks.length"
              class="org-panel__stacks"
            >
              <div
        ...
        <div class="org-panel__card">
          ...
          >
            <span class="org-panel__member-avatar">{{
              member.userId.charAt(0).toUpperCase()
            }}</span>
            <div class="org-panel__member-info">
              <span class="org-panel__member-name">{{ member.userId }}</span>
              <span
                class="org-panel__member-role"
                :class="'org-panel__member-role--' + member.role"
                >{{ member.role }}</span
              >
            </div>
          </div>
        ...
        <div class="org-panel__card">
          ...
          <div class="org-panel__plan-detail-row">
            ...
            <span class="org-panel__plan-detail-value">{{
              subscription.price > 0
...
.org-panel__project-row:last-child {
  border-bottom: none;
}
...
.org-panel__plan-detail-row:last-child {
  border-bottom: none;
}
